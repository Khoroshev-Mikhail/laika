...
export default function Roadmap(){
    return (
        <section id="05Roadmap" className="_section relative mt-28 overflow-visible">

            <div className="_animate-moveUp hidden md:block w-full scale-x-[-1] h-[180%] absolute -bottom-[100%] -z-40 bg-contain bg-no-repeat bg-[url('/img/components/eclipse.webp')]"></div>
            ...
            <div className="_wrapper">
                <h2 className={`${RAYDIS} _h2`}>ROADMAP</h2>
                ...
                <div className="grid grid-rows-4 md:grid-rows-12 grid-cols-2">
                    <div className="col-span-2 md:col-span-1 row-span-1 md:row-span-5">
                        <div className="relative flex flex-col gap-y-2 md:gap-y-0 justify-center md:flex-row h-48 _phase1 ml-8 pr-8 md:pr-0 md:ml-0 ">
                            ...
                            <div data-aos-delay="100" data-aos="zoom-in" data-aos-duration="1500"  className={`${RAYDIS} block w-full md:w-1/3 sm:text-center md:text-left text-[14px] sm:text-[16px] lg:text-[20px] xl:text-[24px] text-white md:pt-10 `}>
                            ...
                            <div data-aos-delay="100" data-aos="zoom-in" data-aos-duration="1500"  className="block sm:mx-auto md:w-2/3 md:ml-8 lg:ml-10 xl:ml-12 md:mt-8">
                                <ul className="pl-4 md:pl-0 leading-tight md:leading-normal list-disc marker:text-_purple font-extrabold text-[16px] xs:text-[14px] sm:text-[16px] xl:text-[20px]">
                    ...
                    <div className="col-span-2 md:col-span-1 row-span-1 md:row-span-5">
                        <div className="relative flex flex-col gap-y-2 md:gap-y-0 justify-center md:flex-row h-48 _phase2 pl-8 md:pl-0 mr-8 mt-[-2px] md:mt-8 md:-ml-0.5 md:pb-8 xl:pb-12">
                            ...
                            <div data-aos-delay="200" data-aos="zoom-in" data-aos-duration="1500"  className={`${RAYDIS} block w-full sm:text-center md:text-left md:w-5/12 lg:w-5/12 text-[14px] sm:text-[16px] lg:text-[20px] xl:text-[24px] text-white md:ml-8 lg:ml-10 xl:ml-12`}>
                    ...
                    <div className="col-span-2 md:col-span-1 row-span-1 md:row-span-5 md:order-last flex:justify-center md:block pr-8 md:pr-0">
                        <div className="relative flex w-full md:w-auto flex-col gap-y-2 md:gap-y-0 md:flex-row justify-center h-48 -mt-1 pr-8 md:-mt-0 ml-8 _phase3 md:-ml-0.5 md:pr-8 md:pb-12 xl:pb-12">
                            ...
                            <div data-aos-delay="300" data-aos="zoom-in" data-aos-duration="1500"  className={`${RAYDIS} block w-full  sm:text-center md:text-left md:w-5/12 lg:w-5/12 md:ml-8 lg:ml-10 xl:ml-12  text-[14px] sm:text-[16px] lg:text-[20px] xl:text-[24px] text-white`}>
                    ...
                    <div className="col-span-2 md:col-span-1 row-span-1 md:row-span-5">
                        ...
                        <svg className="absolute -top-[13px] left-[80%] fill-[#FF7D38] md:fill-[#FFD86B] md:left-[7%] w-7 h-7 md:scale-x-[1] " xmlns="http://www.w3.org/2000/svg" shapeRendering="geometricPrecision" textRendering="geometricPrecision" imageRendering="optimizeQuality" fillRule="evenodd" clipRule="evenodd" viewBox="0 0 312 511.42"><path fillRule="nonzero" d="M306.3 32.62 65.46 252.86 312 478.8l-29.84 32.62L0 252.83 276.46 0z"/></svg>
                            <div data-aos-delay="500" data-aos="zoom-in" data-aos-duration="1500"  className={`${RAYDIS} block w-full sm:text-center md:text-left md:w-5/12 lg:w-5/12  text-[14px] sm:text-[16px] lg:text-[20px] xl:text-[24px] text-white md:pt-12`}>
