    ...
    return (
        <section id="06Footer" className="_section relative z-50 overflow-hidden">
            ...
            <div className="_wrapper pt-[10%]">
                <div className=" border-_blue border-2  md:pt-0 md:p-0 flex flex-col gap-y-8 md:flex-row relative z-40 md:overflow-hidden bg-[#010D31] bg-opacity-50 overflow-hidden">
                {/* <div className="absolute w-full h-full left-0 top-0 bg-[#010D31] -z-10 bg-transparent-1/2"> </div> */}

                <div className="hidden md:block absolute md:top-0 left-[5%] w-full h-full bg-[url('/img/components/07Footer/line_top.svg')] bg-no-repeat bg-left-top z-50"></div>
                <div className="hidden md:block absolute md:top-0 right-[10%] w-full h-full bg-[url('/img/components/07Footer/line_top_2.svg')] bg-no-repeat bg-right-top z-50"></div>
                <div className="absolute bottom-[2%] left-[5%] w-full h-full bg-[url('/img/components/07Footer/line_bottom.svg')] bg-no-repeat bg-left-bottom z-50"></div>
                ...
                <div className="md:hidden absolute w-[110%] h-[110%] -right-1/4 -bottom-[14%] xs:w-[90%] xs:h-[90%] bg-[url('/img/components/07Footer/earth_mobile.webp')] bg-contain bg-no-repeat bg-right-bottom -z-20"> </div> 
                    ...
                    <div className="flex flex-col md:justify-end relative z-50">
